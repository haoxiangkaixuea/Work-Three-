...
public class DataUtils {
    private BookDBHelper myBookDbHelper;

    public DataUtils(BookDBHelper myBookDbHelper) {
        this.myBookDbHelper = myBookDbHelper;
    }

    public void addData() {
        SQLiteDatabase database = myBookDbHelper.getWritableDatabase();
